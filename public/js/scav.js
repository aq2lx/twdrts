...
var addLblArrow = function addLblArrow(idx) {
  var lblArrow = document.createElement('span');
...
var createTable = function createTable(data) {
  ...
  table.appendChild(addRow([addCol('' + data.lvl, { className: 'text-right nw' }), addCol(null, { id: 'lvl-' + data.idx, className: 'clr-success ne' })]));

  table.appendChild(addRow([addCol('' + data.xp, { className: 'text-right sw' }), addCol(null, { id: 'xp-to-' + data.idx, className: 'clr-success se' })]));
